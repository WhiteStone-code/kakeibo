...
const DICT: Record<string, Row> = {
  ...
  'common.total': { es: 'Total', en: 'Total', pt: 'Total', it: 'Totale', fr: 'Total', de: 'Gesamt' },
  'common.optional': { es: 'opcional', en: 'optional', pt: 'opcional', it: 'facoltativo', fr: 'facultatif', de: 'optional' },
  'common.close': { es: 'Cerrar', en: 'Close', pt: 'Fechar', it: 'Chiudi', fr: 'Fermer', de: 'Schließen' },

  // ---------- Temas ----------
  'theme.zen.name': { es: 'Zen', en: 'Zen', pt: 'Zen', it: 'Zen', fr: 'Zen', de: 'Zen' },
  'theme.zen.tagline': { es: 'Matcha, tinta y calma. Disciplina japonesa.', en: 'Matcha, ink and calm. Japanese discipline.', pt: 'Matcha, tinta e calma. Disciplina japonesa.', it: 'Matcha, inchiostro e calma. Disciplina giapponese.', fr: 'Matcha, encre et calme. Discipline japonaise.', de: 'Matcha, Tinte und Ruhe. Japanische Disziplin.' },
  'theme.sakura.name': { es: 'Sakura', en: 'Sakura', pt: 'Sakura', it: 'Sakura', fr: 'Sakura', de: 'Sakura' },
  'theme.sakura.tagline': { es: 'Rosa cerezo, dulce y kawaii.', en: 'Cherry blossom pink, sweet and kawaii.', pt: 'Rosa de cerejeira, doce e kawaii.', it: 'Rosa ciliegio, dolce e kawaii.', fr: 'Rose cerisier, doux et kawaii.', de: 'Kirschblütenrosa, süß und kawaii.' },
  'theme.neon.name': { es: 'Neón', en: 'Neon', pt: 'Neon', it: 'Neon', fr: 'Néon', de: 'Neon' },
  'theme.neon.tagline': { es: 'Energía nocturna, vibrante y eléctrica.', en: 'Night-time energy, vibrant and electric.', pt: 'Energia noturna, vibrante e elétrica.', it: 'Energia notturna, vibrante ed elettrica.', fr: 'Énergie nocturne, vibrante et électrique.', de: 'Nächtliche Energie, lebendig und elektrisch.' },
  'theme.oceano.name': { es: 'Océano', en: 'Ocean', pt: 'Oceano', it: 'Oceano', fr: 'Océan', de: 'Ozean' },
  'theme.oceano.tagline': { es: 'Azules profundos, fresco y relajante.', en: 'Deep blues, cool and relaxing.', pt: 'Azuis profundos, fresco e relaxante.', it: 'Blu profondi, fresco e rilassante.', fr: 'Bleus profonds, frais et relaxant.', de: 'Tiefes Blau, frisch und entspannend.' },
  'theme.bosque.name': { es: 'Bosque', en: 'Forest', pt: 'Floresta', it: 'Foresta', fr: 'Forêt', de: 'Wald' },
  'theme.bosque.tagline': { es: 'Verdes y tierra, cálido y natural.', en: 'Greens and earth tones, warm and natural.', pt: 'Verdes e terra, quente e natural.', it: 'Verdi e terra, caldo e naturale.', fr: 'Verts et terre, chaleureux et naturel.', de: 'Grün- und Erdtöne, warm und natürlich.' },
  ...
  'language.switcherLabel': { es: 'Idioma', en: 'Language', pt: 'Idioma', it: 'Lingua', fr: 'Langue', de: 'Sprache' },
  ...
  'transactions.periodThisMonth': { es: 'Este mes', en: 'This month', pt: 'Este mês', it: 'Questo mese', fr: 'Ce mois-ci', de: 'Diesen Monat' },
  'transactions.periodLast3': { es: 'Últimos 3 meses', en: 'Last 3 months', pt: 'Últimos 3 meses', it: 'Ultimi 3 mesi', fr: '3 derniers mois', de: 'Letzte 3 Monate' },
  'transactions.periodAll': { es: 'Todo el histórico', en: 'Whole history', pt: 'Todo o histórico', it: 'Tutta la cronologia', fr: 'Tout l’historique', de: 'Gesamter Verlauf' },
  'transactions.emptyPeriod': { es: 'No hay movimientos en este período.', en: 'No transactions in this period.', pt: 'Não há movimentos neste período.', it: 'Nessun movimento in questo periodo.', fr: 'Aucun mouvement sur cette période.', de: 'Keine Buchungen in diesem Zeitraum.' },
  ...
  'settings.importSuccess': { es: '¡Datos importados correctamente! 🌸', en: 'Data imported successfully! 🌸', pt: 'Dados importados com sucesso! 🌸', it: 'Dati importati correttamente! 🌸', fr: 'Données importées avec succès ! 🌸', de: 'Daten erfolgreich importiert! 🌸' },
  'settings.importError': { es: 'No se pudo leer el archivo. ¿Seguro que es un backup de Kakeibo?', en: "Couldn't read the file. Is it really a Kakeibo backup?", pt: 'Não foi possível ler o ficheiro. É mesmo uma cópia de segurança do Kakeibo?', it: 'Impossibile leggere il file. Sei sicuro che sia un backup di Kakeibo?', fr: "Impossible de lire le fichier. Est-ce bien une sauvegarde de Kakeibo ?", de: 'Die Datei konnte nicht gelesen werden. Ist es wirklich ein Kakeibo-Backup?' },
  'settings.resetConfirm': { es: 'Esto borrará todos tus movimientos, objetivos y logros. ¿Continuar?', en: 'This will delete all your transactions, goals and achievements. Continue?', pt: 'Isto vai apagar todos os teus movimentos, objetivos e conquistas. Continuar?', it: 'Questo eliminerà tutti i tuoi movimenti, obiettivi e obiettivi sbloccati. Continuare?', fr: 'Cela supprimera tous tes mouvements, objectifs et succès. Continuer ?', de: 'Dadurch werden alle deine Buchungen, Ziele und Erfolge gelöscht. Fortfahren?' },
  ...
  'shopping.budgetPlaceholder': { es: 'Ej: 40', en: 'E.g.: 40', pt: 'Ex: 40', it: 'Es: 40', fr: 'Ex : 40', de: 'Z. B.: 40' },
  'shopping.priceInputTitle': { es: 'Precio estimado en {currency} (opcional)', en: 'Estimated price in {currency} (optional)', pt: 'Preço estimado em {currency} (opcional)', it: 'Prezzo stimato in {currency} (facoltativo)', fr: 'Prix estimé en {currency} (facultatif)', de: 'Geschätzter Preis in {currency} (optional)' },
  'shopping.registerNote': { es: 'Compra: {names}', en: 'Purchase: {names}', pt: 'Compra: {names}', it: 'Acquisto: {names}', fr: 'Achat : {names}', de: 'Einkauf: {names}' },
  ...
  'shopping.share.noPending': { es: '(sin productos pendientes)', en: '(no pending items)', pt: '(sem produtos pendentes)', it: '(nessun prodotto in sospeso)', fr: '(aucun article en attente)', de: '(keine ausstehenden Artikel)' },
  'shopping.share.noStoreAssigned': { es: 'Sin tienda asignada', en: 'No store assigned', pt: 'Sem loja atribuída', it: 'Nessun negozio assegnato', fr: 'Aucun magasin assigné', de: 'Kein Laden zugewiesen' },
  'shopping.addOwnStore': { es: '+ Añadir tu tienda', en: '+ Add your store', pt: '+ Adicionar a tua loja', it: '+ Aggiungi il tuo negozio', fr: '+ Ajouter ton magasin', de: '+ Eigenen Laden hinzufügen' },
  'shopping.ownStorePlaceholder': { es: 'Ej: Carnicería del barrio', en: 'E.g.: Local butcher shop', pt: 'Ex: Talho do bairro', it: 'Es: Macelleria del quartiere', fr: 'Ex : Boucherie du quartier', de: 'Z. B.: Metzgerei um die Ecke' },
  'shopping.whereToBuy': { es: '¿Dónde lo compras?', en: 'Where do you buy it?', pt: 'Onde o compras?', it: 'Dove lo compri?', fr: 'Où l’achètes-tu ?', de: 'Wo kaufst du es?' },
  'recurring.title': { es: 'Gastos e ingresos fijos', en: 'Fixed expenses & income', pt: 'Despesas e receitas fixas', it: 'Spese ed entrate fisse', fr: 'Dépenses et revenus fixes', de: 'Feste Ausgaben & Einnahmen' },
  'recurring.desc': { es: 'Cosas que se repiten cada mes: la nómina, el alquiler, una aportación automática a inversión... El día que toca, te lo recordamos en el Panel para que lo confirmes con un toque.', en: 'Things that repeat every month: your salary, rent, an automatic investment transfer... On the day it’s due, we remind you on the Dashboard so you can confirm it in one tap.', pt: 'Coisas que se repetem todos os meses: o salário, a renda, uma transferência automática para investimento... No dia certo, lembramos-te no Painel para confirmares com um toque.', it: 'Cose che si ripetono ogni mese: lo stipendio, l’affitto, un versamento automatico per investimenti... Il giorno giusto, te lo ricordiamo nel Pannello per confermarlo con un tocco.', fr: 'Des choses qui reviennent chaque mois : le salaire, le loyer, un virement automatique vers un investissement... Le jour venu, on te le rappelle sur le tableau de bord pour confirmer en un geste.', de: 'Dinge, die sich jeden Monat wiederholen: Gehalt, Miete, eine automatische Investition... Am fälligen Tag erinnern wir dich in der Übersicht, damit du es mit einem Tipp bestätigst.' },
  'recurring.dayLabel': { es: 'día {day}', en: 'day {day}', pt: 'dia {day}', it: 'giorno {day}', fr: 'jour {day}', de: 'Tag {day}' },
  'recurring.active': { es: 'Activo', en: 'Active', pt: 'Ativo', it: 'Attivo', fr: 'Actif', de: 'Aktiv' },
  'recurring.paused': { es: 'Pausado', en: 'Paused', pt: 'Pausado', it: 'In pausa', fr: 'En pause', de: 'Pausiert' },
  'recurring.namePlaceholder': { es: 'Ej: Alquiler, Nómina, Aportación inversión…', en: 'E.g.: Rent, Salary, Investment transfer…', pt: 'Ex: Renda, Salário, Transferência investimento…', it: 'Es: Affitto, Stipendio, Versamento investimenti…', fr: 'Ex : Loyer, Salaire, Virement investissement…', de: 'Z. B.: Miete, Gehalt, Investitionsüberweisung…' },
  'recurring.dayOfMonth': { es: 'Día', en: 'Day', pt: 'Dia', it: 'Giorno', fr: 'Jour', de: 'Tag' },
  'recurring.add': { es: '+ Añadir fijo', en: '+ Add fixed item', pt: '+ Adicionar fixo', it: '+ Aggiungi fisso', fr: '+ Ajouter un élément fixe', de: '+ Fixposten hinzufügen' },
  'recurring.dueTitle': { es: '📅 Toca hoy', en: '📅 Due today', pt: '📅 Toca hoje', it: '📅 Scade oggi', fr: '📅 À faire aujourd’hui', de: '📅 Heute fällig' },
  'recurring.skip': { es: 'Saltar', en: 'Skip', pt: 'Saltar', it: 'Salta', fr: 'Ignorer', de: 'Überspringen' },
  'recurring.register': { es: '✅ Registrar', en: '✅ Log it', pt: '✅ Registar', it: '✅ Registra', fr: '✅ Enregistrer', de: '✅ Erfassen' },
  'settings.recurring': { es: 'Fijos', en: 'Fixed', pt: 'Fixos', it: 'Fissi', fr: 'Fixes', de: 'Fixposten' },
  ...
  'invest.chartYearLabel': { es: 'Año {years}', en: 'Year {years}', pt: 'Ano {years}', it: 'Anno {years}', fr: 'Année {years}', de: 'Jahr {years}' },
  ...
  // ---------- Frases diarias del mascota (dashboard) ----------
  'quote.0': { es: 'Kaizen: mejora un 1% cada día. El ahorro no es un salto, es una costumbre.', en: "Kaizen: improve by 1% every day. Saving isn't a leap, it's a habit.", pt: 'Kaizen: melhora 1% a cada dia. Poupar não é um salto, é um hábito.', it: "Kaizen: migliora dell'1% ogni giorno. Risparmiare non è un salto, è un'abitudine.", fr: 'Kaizen : améliore-toi de 1 % chaque jour. Épargner n’est pas un bond, c’est une habitude.', de: 'Kaizen: Verbessere dich jeden Tag um 1 %. Sparen ist kein Sprung, sondern eine Gewohnheit.' },
  'quote.1': { es: 'Una gota no hace un océano, pero muchas gotas sí. Cada € cuenta.', en: "One drop doesn't make an ocean, but many drops do. Every € counts.", pt: 'Uma gota não faz um oceano, mas muitas gotas sim. Cada € conta.', it: 'Una goccia non fa un oceano, ma tante gocce sì. Ogni € conta.', fr: 'Une goutte ne fait pas un océan, mais beaucoup de gouttes, si. Chaque € compte.', de: 'Ein Tropfen macht keinen Ozean, aber viele Tropfen schon. Jeder € zählt.' },
  'quote.2': { es: 'El bambú se dobla con el viento pero nunca se rompe. Flexible con el plan, firme con la meta.', en: 'Bamboo bends in the wind but never breaks. Be flexible with the plan, firm with the goal.', pt: 'O bambu dobra-se com o vento mas nunca se parte. Flexível com o plano, firme com a meta.', it: "Il bambù si piega col vento ma non si spezza mai. Flessibile con il piano, fermo con l'obiettivo.", fr: 'Le bambou plie avec le vent mais ne casse jamais. Flexible sur le plan, ferme sur l’objectif.', de: 'Bambus biegt sich im Wind, bricht aber nie. Flexibel beim Plan, fest beim Ziel.' },
  'quote.3': { es: 'Antes de comprar, pregúntate: ¿esto me acerca o me aleja de mi objetivo?', en: 'Before buying, ask yourself: does this bring me closer to my goal, or further away?', pt: 'Antes de comprar, pergunta-te: isto aproxima-me ou afasta-me do meu objetivo?', it: 'Prima di comprare, chiediti: questo mi avvicina o mi allontana dal mio obiettivo?', fr: 'Avant d’acheter, demande-toi : est-ce que cela me rapproche ou m’éloigne de mon objectif ?', de: 'Bevor du kaufst, frag dich: Bringt mich das meinem Ziel näher oder weiter weg?' },
  'quote.4': { es: '"Mottainai" — no desperdicies. Reutiliza, repara, reflexiona antes de gastar.', en: '"Mottainai" — don’t waste. Reuse, repair, reflect before spending.', pt: '"Mottainai" — não desperdices. Reutiliza, repara, reflete antes de gastar.', it: '"Mottainai" — non sprecare. Riutilizza, ripara, rifletti prima di spendere.', fr: '« Mottainai » — ne gaspille pas. Réutilise, répare, réfléchis avant de dépenser.', de: '„Mottainai“ – verschwende nichts. Wiederverwenden, reparieren, nachdenken, bevor du ausgibst.' },
  'quote.5': { es: 'Apunta cada gasto de hoy: lo que se mide, se mejora.', en: 'Write down every expense today: what gets measured gets improved.', pt: 'Regista cada gasto de hoje: o que se mede, melhora-se.', it: 'Annota ogni spesa di oggi: ciò che si misura, si migliora.', fr: 'Note chaque dépense d’aujourd’hui : ce qui est mesuré s’améliore.', de: 'Notiere heute jede Ausgabe: Was gemessen wird, wird besser.' },
  'quote.6': { es: 'El camino de los mil ryos empieza con una sola moneda ahorrada.', en: 'The journey of a thousand ryo begins with a single coin saved.', pt: 'O caminho dos mil ryos começa com uma única moeda poupada.', it: 'Il cammino dei mille ryo inizia con una singola moneta risparmiata.', fr: 'Le chemin des mille ryos commence par une seule pièce économisée.', de: 'Der Weg der tausend Ryo beginnt mit einer einzigen gesparten Münze.' },
  'quote.7': { es: 'No ahorres lo que sobra al gastar, gasta lo que sobra al ahorrar.', en: "Don't save what's left after spending — spend what's left after saving.", pt: 'Não poupes o que sobra ao gastar, gasta o que sobra ao poupar.', it: 'Non risparmiare ciò che avanza dopo aver speso, spendi ciò che avanza dopo aver risparmiato.', fr: 'N’épargne pas ce qu’il reste après avoir dépensé, dépense ce qu’il reste après avoir épargné.', de: 'Spare nicht, was nach dem Ausgeben übrig bleibt – gib aus, was nach dem Sparen übrig bleibt.' },
  'quote.8': { es: 'Un pequeño hábito diario vence a una gran intención ocasional.', en: 'A small daily habit beats a big occasional intention.', pt: 'Um pequeno hábito diário vence uma grande intenção ocasional.', it: 'Una piccola abitudine quotidiana batte una grande intenzione occasionale.', fr: 'Une petite habitude quotidienne bat une grande intention occasionnelle.', de: 'Eine kleine tägliche Gewohnheit schlägt eine große gelegentliche Absicht.' },
  'quote.9': { es: 'La calma del Zen también se aplica a tus finanzas: respira antes de comprar por impulso.', en: 'Zen calm applies to your finances too: breathe before an impulse buy.', pt: 'A calma Zen também se aplica às tuas finanças: respira antes de comprar por impulso.', it: 'La calma Zen si applica anche alle tue finanze: respira prima di un acquisto d’impulso.', fr: 'Le calme du Zen s’applique aussi à tes finances : respire avant un achat impulsif.', de: 'Die Zen-Ruhe gilt auch für deine Finanzen: Atme durch, bevor du impulsiv kaufst.' },
  'quote.10': { es: 'Revisa tu mes como un maestro revisa su técnica: sin juicio, con curiosidad.', en: 'Review your month like a master reviews their technique: without judgment, with curiosity.', pt: 'Revê o teu mês como um mestre revê a sua técnica: sem julgamento, com curiosidade.', it: 'Rivedi il tuo mese come un maestro rivede la sua tecnica: senza giudizio, con curiosità.', fr: 'Revois ton mois comme un maître revoit sa technique : sans jugement, avec curiosité.', de: 'Betrachte deinen Monat wie ein Meister seine Technik: ohne Urteil, mit Neugier.' },
  'quote.11': { es: 'Tu objetivo no está lejos: está a un registro diario de distancia.', en: "Your goal isn't far away: it's just one daily log away.", pt: 'O teu objetivo não está longe: está a um registo diário de distância.', it: 'Il tuo obiettivo non è lontano: è a una registrazione quotidiana di distanza.', fr: 'Ton objectif n’est pas loin : il est à un enregistrement quotidien de distance.', de: 'Dein Ziel ist nicht weit weg: nur einen täglichen Eintrag entfernt.' },
  'quote.12': { es: 'El ahorro constante es la forma más silenciosa de disciplina.', en: 'Steady saving is the quietest form of discipline.', pt: 'A poupança constante é a forma mais silenciosa de disciplina.', it: 'Il risparmio costante è la forma più silenziosa di disciplina.', fr: 'L’épargne régulière est la forme la plus silencieuse de discipline.', de: 'Stetiges Sparen ist die leiseste Form von Disziplin.' },
  'quote.13': { es: 'Hoy es un buen día para acercarte un poco más a tu sueño.', en: 'Today is a good day to get a little closer to your dream.', pt: 'Hoje é um bom dia para te aproximares um pouco mais do teu sonho.', it: 'Oggi è un buon giorno per avvicinarti un po’ di più al tuo sogno.', fr: 'Aujourd’hui est un bon jour pour te rapprocher un peu plus de ton rêve.', de: 'Heute ist ein guter Tag, um deinem Traum ein Stück näherzukommen.' },
  'quote.14': { es: 'La paciencia financiera de hoy es la libertad de mañana.', en: 'Financial patience today is freedom tomorrow.', pt: 'A paciência financeira de hoje é a liberdade de amanhã.', it: 'La pazienza finanziaria di oggi è la libertà di domani.', fr: 'La patience financière d’aujourd’hui est la liberté de demain.', de: 'Finanzielle Geduld heute ist die Freiheit von morgen.' },
};
